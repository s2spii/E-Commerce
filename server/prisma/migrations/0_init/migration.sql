...
-- CreateEnum
CREATE TYPE "StockMovementReason" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'RESERVATION_RELEASE');
...
CREATE TABLE "Order" (
    ...
    "currency" CHAR(3) NOT NULL DEFAULT 'EUR',
    "subtotalExclTax" INTEGER NOT NULL,
    "discountTotal" INTEGER NOT NULL DEFAULT 0,
    "shippingExclTax" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "OrderItem" (
    ...
    "sku" TEXT NOT NULL,
    "quantity" INTEGER NOT NULL,
    "unitPriceExclTax" INTEGER NOT NULL,
    "taxClass" TEXT NOT NULL DEFAULT 'STANDARD',
    "taxRate" INTEGER NOT NULL,
    "taxAmount" INTEGER NOT NULL,
    "discountAmount" INTEGER NOT NULL DEFAULT 0,
    "lineTotalExclTax" INTEGER NOT NULL,
    "lineTotalInclTax" INTEGER NOT NULL,
...
-- CreateIndex
CREATE INDEX "TaxRate_countryCode_taxClass_idx" ON "TaxRate"("countryCode", "taxClass");

-- CreateIndex
CREATE UNIQUE INDEX "TaxRate_countryCode_taxClass_validFrom_key" ON "TaxRate"("countryCode", "taxClass", "validFrom");
